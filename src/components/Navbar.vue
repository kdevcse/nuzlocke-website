<template>
    <b-navbar variant="dark" type="dark">
        ...
        <b-navbar-nav class="ml-auto navbar-nav">
            <Login></Login>
            <b-nav-item-dropdown v-if="!isLoggedIn" title="Profile" variant="link" toggle-class="text-decoration-none" right no-caret>
                <template #button-content>
                    <b-icon variant="light" icon="person-circle"></b-icon>
                </template>
                <b-dropdown-item-button v-b-modal.login-window>Login</b-dropdown-item-button>
            </b-nav-item-dropdown>
            <b-nav-item-dropdown v-else title="Profile" variant="link" toggle-class="text-decoration-none" right no-caret>
                <template #button-content>
                    <b-icon variant="light" icon="person-circle"></b-icon>
                </template>
